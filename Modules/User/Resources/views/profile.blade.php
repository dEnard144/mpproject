    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <p class="font-italic">Changer les informations de votre profil & votre mot de passe ici...</p>
            </div>
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('profile.update') }}" method="POST">
                            ...
                            <div class="form-group">
                                <label for="image">Photo de profil <span class="text-danger">*</span></label>
