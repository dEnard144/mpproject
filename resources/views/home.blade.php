                ...
                <div class="card border-0">
                    <div class="card-body p-0 d-flex align-items-center shadow-sm">
                        ...
                        <div>
                            ...
                            <div class="text-muted text-uppercase font-weight-bold small">Chiffre d'Affaire</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-0">
                    <div class="card-body p-0 d-flex align-items-center shadow-sm">
                        ...
                        <div>
                            ...
                            <div class="text-muted text-uppercase font-weight-bold small">Articles Vendus</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-0">
                    <div class="card-body p-0 d-flex align-items-center shadow-sm">
                        ...
                        <div>
                            ...
                            <div class="text-muted text-uppercase font-weight-bold small">Articles achetés</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-7">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-header">
                            Achats et Ventes de ces 7 derniers jours
                        </div>
                        <div class="card-body">
