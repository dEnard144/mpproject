...
<ul class="c-header-nav ml-auto mr-4">
    ...
    <li class="c-header-nav-item mr-3">
        <a class="btn btn-primary btn-pill {{ request()->routeIs('app.pos.index') ? 'disabled' : '' }}" href="{{ route('app.pos.index') }}">
            <i class="bi bi-cart mr-1"></i> Caisse
        </a>
    </li>
    @endcan
        ...
        <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg pt-0">
            ...
            @forelse($low_quantity_products as $product)
                <a class="dropdown-item" href="{{ route('products.show', $product->id) }}">
                    <i class="bi bi-hash mr-1 text-primary"></i> Le produit: "{{ $product->product_code }}" a atteint le stock critique!
                </a>
            @empty
                <a class="dropdown-item" href="#">
                    <i class="bi bi-app-indicator mr-2 text-danger"></i> Pas de notifications disponible.
                </a>
            @endforelse
        </div>
    </li>
    ...
    <li class="c-header-nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right pt-0">
            ...
            <a class="dropdown-item" href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                <i class="mfe-2  bi bi-box-arrow-left" style="font-size: 1.2rem;"></i> Se déconnecter
            </a>
